...
1. Open the `VLCPortable` folder and double-click `VLCPortable.exe` to launch VLC.
...
* Extract the video files and drop them directly into this folder path within the project: `App/vlc/Videos/`
